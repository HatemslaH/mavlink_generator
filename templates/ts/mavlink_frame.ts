...
export class MavlinkFrame {
  static readonly MAVLINK_STX_V1 = 0xfe;
  static readonly MAVLINK_STX_V2 = 0xfd;

  constructor(
    public readonly version: MavlinkVersion,
    public readonly sequence: number,
    public readonly systemId: number,
    public readonly componentId: number,
    public readonly message: MavlinkMessage,
  ) {}
  ...
  serialize(): Uint8Array {
    if (this.version === MavlinkVersion.V1) {
      return this.serializeV1();
    }
    return this.serializeV2();
  }

  private serializeV1(): Uint8Array {
  ...
  private serializeV2(): Uint8Array {
    const incompatibilityFlags = 0;
    const compatibilityFlags = 0;
    const payload = MavlinkFrame.trimTrailingZeros(this.message.serialize());
    const payloadLength = payload.length;
  ...
  private static trimTrailingZeros(payload: Uint8Array): Uint8Array {

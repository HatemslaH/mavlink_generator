...
pub fn dialect_guard_name(dialect_stem: &str) -> String {
    format!(
        "MAVLINK_DIALECT_{}_H",
        dialect_stem.to_uppercase().replace('-', "_")
    )
}

pub fn unique_enum_entry_c_name(entry: &DialectEntry, used_names: &mut HashSet<String>) -> String {
...
pub fn as_c_type(mavlink_type: &str, enum_name: Option<&str>, is_bitmask: bool) -> String {
    as_c_base_type(mavlink_type, enum_name, is_bitmask)
}

pub fn as_c_base_type(mavlink_type: &str, enum_name: Option<&str>, is_bitmask: bool) -> String {
